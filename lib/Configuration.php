...
class Configuration
{
     ...
     * @var string
     */
    protected $host = "https://api-gateway.sajari.com";

    /**
     * User agent of the HTTP request, unset by default because the client
     * user agent is set using the Sajari-Client-User-Agent header.
     *
     * @var string
     */
    protected $userAgent = "";
    ...
    {
        $report = "PHP SDK (Sajari) Debug Report:" . PHP_EOL;
