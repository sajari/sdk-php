...
class PipelineStep implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        "description" => "string",
        "id" => "string",
        "params" => "array<string,\Sajari\Model\PipelineStepParamBinding>",
        "title" => "string",
    ];
     ...
     * Sets condition
     *
     * @param string|null $condition Condition expression to determine if the step should be run.  This is a filter expression much like the query filter expression, but it acts upon the pipeline variables.  For example, to only run the step if the pipeline `q` variable is not empty, set this to `q != ''`.
     *
     * @return self
     */
     ...
     * Gets params
     *
     * @return array<string,\Sajari\Model\PipelineStepParamBinding>|null
     */
     ...
     * Sets params
     *
     * @param array<string,\Sajari\Model\PipelineStepParamBinding>|null $params Bindings for the step parameters.
     *
     * @return self
     */
