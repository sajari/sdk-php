...
/**
 * ListPipelinesResponse Class Doc Comment
 *
 * @category Class
 * @package  Sajari
 * @author   OpenAPI Generator team
 ...
 */
class ListPipelinesResponse implements
    ModelInterface,
    ArrayAccess,
    \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        "pipelines" => "\Sajari\Model\Pipeline[]",
    ];
     ...
     * Sets pipelines
     *
     * @param \Sajari\Model\Pipeline[]|null $pipelines The pipelines from the specified collection.
     *
     * @return self
     */
