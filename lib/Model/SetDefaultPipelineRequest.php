...
/**
 * SetDefaultPipelineRequest Class Doc Comment
 *
 * @category Class
 * @package  Sajari
 * @author   OpenAPI Generator team
 ...
 */
class SetDefaultPipelineRequest implements
    ModelInterface,
    ArrayAccess,
    \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = "SetDefaultPipelineRequest";
     ...
     * Sets pipeline
     *
     * @param string $pipeline The name of the pipeline to use when not otherwise specified.
     *
     * @return self
     */
