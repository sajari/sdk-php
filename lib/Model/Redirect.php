...
class Redirect implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets collection_id
     *
     * @param string|null $collection_id The ID of the collection that owns this redirect.
     *
     * @return self
     */
     ...
     * Sets create_time
     *
     * @param \DateTime|null $create_time The time the redirect was created.
     *
     * @return self
     */
     ...
     * Sets update_time
     *
     * @param \DateTime|null $update_time The time the redirect was last updated.
     *
     * @return self
     */
