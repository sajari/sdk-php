...
class Collection implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets account_id
     *
     * @param string|null $account_id The ID of the account that owns this collection.
     *
     * @return self
     */
     ...
     * Sets create_time
     *
     * @param \DateTime|null $create_time The time the collection was created.
     *
     * @return self
     */
     ...
     * Sets id
     *
     * @param string|null $id The collection's ID.
     *
     * @return self
     */
