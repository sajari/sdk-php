...
/**
 * QueryAggregateResultCount Class Doc Comment
 *
 * @category Class
 ...
 */
class QueryAggregateResultCount implements
    ModelInterface,
    ArrayAccess,
    \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = "QueryAggregateResultCount";
     ...
     * Sets counts
     *
     * @param map[string,int]|null $counts counts
     *
     * @return self
     */
