...
/**
 * BatchCreateSchemaFieldsResponse Class Doc Comment
 *
 * @category Class
 * @package  Sajari
 * @author   OpenAPI Generator team
 ...
 */
class BatchCreateSchemaFieldsResponse implements
    ModelInterface,
    ArrayAccess,
    \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = "BatchCreateSchemaFieldsResponse";
     ...
     * Sets errors
     *
     * @param \Sajari\Model\BatchCreateSchemaFieldsResponseError[]|null $errors Errors that occurred.
     *
     * @return self
     */
