...
class Pipeline implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     *
     * @param bool|null $collection_default Indicates if the pipeline is the collection default pipeline.
     *
     * @return self
     */
     ...
     * Sets create_time
     *
     * @param \DateTime|null $create_time The time the pipeline was created.
     *
     * @return self
     */
     ...
     *
     * @param bool|null $default_version Indicates if the pipeline is the default version.
     *
     * @return self
     */
