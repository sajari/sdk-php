...
class Promotion implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets collection_id
     *
     * @param string|null $collection_id The ID of the collection that owns this promotion.
     *
     * @return self
     */
     ...
     * Sets create_time
     *
     * @param \DateTime|null $create_time The time the promotion was created.
     *
     * @return self
     */
     ...
     * Sets update_time
     *
     * @param \DateTime|null $update_time The time the promotion was last updated.
     *
     * @return self
     */
