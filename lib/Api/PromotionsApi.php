...
class PromotionsApi
{
     ...
     * @param  string $view The amount of information to include in each retrieved promotion.   - BASIC: Include basic information including name, start time and end time, but not detailed information about the promotion effects.  - FULL: Returns all information about a promotion. This is the default value. (optional, default to 'PROMOTION_VIEW_UNSPECIFIED')
     *
     * @throws \Sajari\ApiException on non-2xx response
     * @throws \InvalidArgumentException
