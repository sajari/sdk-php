...
class SchemaApi
{
     ...
     * @param  string $parent The parent resource where the schema field is to be created.  Format:   - accounts/{account}/collections/{collection}   - accounts/{account}/collections/{collection}/schemaFields/{schemaField} (optional)
     * @param  string $account_id The account that owns the collection, e.g. &#x60;1618535966441231024&#x60;. (optional)
     *
     * @throws \Sajari\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     */
    public function createSchemaFieldWithHttpInfo(
        $collection_id,
        $schema_field,
        $parent = null,
        $account_id = null
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createSchemaFieldAsync(
        $collection_id,
        $schema_field,
        $parent = null,
        $account_id = null
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function createSchemaFieldRequest(
        $collection_id,
        $schema_field,
        $parent = null,
        $account_id = null
     ...
     */
    public function deleteSchemaField(
        $collection_id,
        $schema_field_name,
        $account_id = null
    ) {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function deleteSchemaFieldAsync(
        $collection_id,
        $schema_field_name,
        $account_id = null
    ) {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function deleteSchemaFieldRequest(
        $collection_id,
        $schema_field_name,
        $account_id = null
    ) {
     ...
     * @param  string $parent The parent to list schema fields from.  Format:   - accounts/{account}/collections/{collection}   - accounts/{account}/collections/{collection}/schemaFields/{schemaField} (optional)
     * @param  string $account_id The account that owns the collection, e.g. &#x60;1618535966441231024&#x60;. (optional)
