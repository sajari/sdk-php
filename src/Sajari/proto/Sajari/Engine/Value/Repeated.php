 ...
 * Repeated values
 *
 * Generated from protobuf message <code>sajari.engine.Value.Repeated</code>
 */
class Repeated extends \Google\Protobuf\Internal\Message
{
    /**
...
class_alias(Repeated::class, \Sajari\Engine\Value_Repeated::class);
