...
use Sajari\Common\Exception\Parser\ExceptionParserInterface;
...
class NamespaceExceptionFactory implements ExceptionFactoryInterface
{
    ...
    public function __construct(
        ...
        $baseNamespace,
        $defaultException = 'Sajari\Common\Exception\ServiceResponseException'
    ) {
        $this->parser = $parser;
    ...
    public function fromResponse(Response $response)
    {
        ...
        // Removing leading 'Sajari.' and embedded periods
        $className = $this->baseNamespace.'\\'.str_replace(array('Sajari.', '.'), '', $parts['code']);
